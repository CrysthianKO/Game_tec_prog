...
{
    //std::cout << "Menu Inicializado. Use as teclas 1 ou 2 para selecionar a fase." << std::endl;
    ...
    txtLevel1.setPosition(btnLevel1.getPosition().x + 25.f, btnLevel1.getPosition().y + 12.f);

    // Configuração do Botão 2 (Fase Extincao)
    btnLevel2.setSize(sf::Vector2f(200.f, 50.f));
    btnLevel2.setFillColor(sf::Color::Red);
    btnLevel2.setPosition(sf::Vector2f(posX / 2, btnLevel1.getPosition().y + 100.f));
...
bool Menu::isMouseOver(const sf::RectangleShape& button, const sf::RenderWindow& window)
{
