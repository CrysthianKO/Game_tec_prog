...
//
//Ranking::Ranking() : Ente(), State(), pPlay(NULL), playerName(" "), playerScore(0), nameEntered(false)
//{
...
//    txtTitle.setPosition(sf::Vector2f(posX / 2 - 100.f, 50.f));
//
//    // Prompt de Input
...
//        else if (event.text.unicode < 128 && event.text.unicode != 13 && event.text.unicode != 32)
//        {
...
//}
//
//void Ranking::setPlayer(Player* pP, int score)
//{
//    pPlay = pP;
//    playerScore = score;
//}
